...
<div role="main" class="ui-content">
    ...
    <table id="tabel-inbox" data-role="table" data-mode="columntoggle" data-column-btn-theme="b" data-column-btn-text="Kolom..." data-column-popup-theme="b" class="ui-responsive table-stroke">
        ...
        <tbody>
            ...
            $akses = $user->roles[0];
            $menu = "";
            $lihat = $db->query("select * from e_surat_masuk limit 20");
            while ($row = $lihat->fetch(PDO::FETCH_BOTH)) {
                ...
                if ($akses == 'pegawai') {
                    ...
                    if (!($ds_kadin || $ds_kabid)) {
                        $menu .= " <a data-edit='"
                                . $row['nomor_surat']
                                . "' href='mobile-page-inbox-edit.php?kode="
                    ...
                    $menu .= " <a data-ajax='false' data-disposisi='" . $row['nomor_surat'] . "' href='mobile-page-inbox-disposisi.php?nomor-surat=" . $row['nomor_surat'] . "' id='disposisi'><i class='fa fa-legal'></i></a>";
                }
                $menu .= '</center>';
