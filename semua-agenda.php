    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Manager Agenda</h3>
   ...
   padding:25px;
     background:#ffffff;
			...
			<div id="frameWrap">
                ...
                <iframe id="iframe1" style="width:100%;height:600px" src="http://localhost/wordpress/wp-admin/edit.php?post_type=agenda" frameborder="0" allowfullscreen></iframe>
            </div>
			</div>
			<script>
