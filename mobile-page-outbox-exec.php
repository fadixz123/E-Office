...
if (isset($_GET['edit'])) {
    ...
    if (empty($pengirim)) {
        ...
        try {
            $backup_data = $db->prepare("select pengirim, perihal, keterangan, penerima from e_surat_keluar where nomor_surat=? limit 1");
            ...
            header("location:mobile-page-outbox.php");
